...
simple_plot_flag_outliers(simple_merge_df, "Black River Falls", size = 3)
```
...
p1%>%
  lm(log(roll_case) ~ log(roll_N12),data = .)%>%
  summary()
...
```{r smoothing}
loessSmoothMod(simple_merge_df, "N1", "smooth_N1")
