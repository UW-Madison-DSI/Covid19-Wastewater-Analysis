...
#Flagging problems doc:
#mainly catching noise: Both
#ignoring longer trends: Both
#day of week effect: Case
...
#smooth data
#remove case outlier
#?get longer trend first, backtrack to short term
#remove outlier data not smooth
```
