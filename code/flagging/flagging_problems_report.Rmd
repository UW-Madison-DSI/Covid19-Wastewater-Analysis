...
knitr::knit_hooks$set(plot = function(x, options) {  # set new plot hook ...
  ...
  wf <- sprintf("\\noindent\\begin{wrapfigure}[%g]{%s}{%g\\textwidth}", options$PlotHeight,
                "R", options$Plot.size)
...
between normal fluctuation and start of a spike. 

A single case flag is suspect but 5 case flags in a row is much more likely to 
repersent a true rise in covid-19 in the population. This confidence is not currently
...
\
```{r fig.cap = "Zoomed in case slope plot", PlotHeight = 20}
