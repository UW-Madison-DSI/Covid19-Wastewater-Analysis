...
```{r create wastewater data, eval = FALSE, echo = FALSE}
...
```{r wastewater flags, eval = FALSE, echo = FALSE}
...
```{r create case flags, eval = FALSE, echo = FALSE}
...
```{r merge flag DF, eval = FALSE, echo = FALSE}
...
```{r plotly plots, eval = FALSE, echo = FALSE}
...
```{r peter LM, eval = FALSE, echo = FALSE}
