...
with the log of the data covariates other than population are not necessary. None
of the detrended data correlates meaningful supporting the view that they are mostly
caused by noise.
